...
const usersController = {
    listUsers: function (req, res) {
        db.User.findAll({
            ...
            .then(function (users) {
                res.render(path.join(__dirname, '../views/users/listUsers'), {
                    users
                })
            })
    },
    ...
    detailUsers: function (req, res) {
        ...
        db.User.findByPk(req.params.id, {
            ...
            console.log(user)
            return res.render(path.join(__dirname, '../views/users/userDetail'), {
                user
            })
        })
    },
                        ...
                        .then(function (userNameRegistered) {
                            ...
                            if (userNameInDB != null) {
                                return res.render(path.join(__dirname, '../views/users/register'), {
                                    errors: {
                                        user_name: {
                                            msg: 'Este nombre de usuario ya se encuentra registrado'
                                        }
                                    },
                                    old: req.body
                                });
    ...
    editUsersPassword: function (req, res) {
        return res.render(path.join(__dirname, '../views/users/userEditPassword'), {
